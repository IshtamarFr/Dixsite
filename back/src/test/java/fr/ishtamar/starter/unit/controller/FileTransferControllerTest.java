package fr.ishtamar.starter.unit.controller;
...
class FileTransferControllerTest {
    ...
    void testGetPicture() throws Exception {
        ...
        //When
        mockMvc.perform(get("/file/dixee.jpg"))
    ...
    @Test
    @DisplayName("When I try to get an inexistant picture, I get an OK (with crop-default)")
    @WithMockUser(roles="USER")
    void testGetInexistantPicture() throws Exception {
        //Given

        //When
        mockMvc.perform(get("/file/dixee2.jpg"))
